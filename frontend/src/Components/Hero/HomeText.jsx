    ...
    <div className="socialMedia">
        ...
        <div className="links">
            <ul>
                ...
                <li>
                <a href="https://twitter.com/ThembaG3"><i className="fa-brands fa-stack-overflow"></i></a>
                </li>
                <li>
                <a href="https://www.facebook.com/malume.jakaza"><i className="fa-brands fa-github"></i></a>
                </li>
            </ul>
        </div>
    </div>
